const zhPart1 = {
  ...
  settings: {
    ...
    runtimePoolDescription: "统一查看受管 Codex runtime 的热度、预算、诊断与人工干预状态。",
    ...
    runtimeBudgetDescription: "把 runtime 数量从“工作区数量驱动”改成“预算驱动”，这是这套方案的核心。",
    runtimeMaxHot: "Codex Hot 上限",
    runtimeMaxHotHelp: "允许同时保持可直接复用的热实例数量。更大更快，但会更吃内存。",
    runtimeMaxWarm: "Codex Warm 上限",
    runtimeMaxWarmHelp: "允许保留的温实例数量。Warm 不活跃，但比 Cold 更容易回温。",
    runtimeWarmTtl: "Warm TTL（秒）",
    runtimeWarmTtlHelp: "Warm 实例在无人使用时最多保留多久，超时后自动回收到 Cold。",
